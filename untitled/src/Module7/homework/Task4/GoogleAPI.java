...
public class GoogleAPI implements API {
   ...
   private List<Room1> room1s = new ArrayList<Room1>();
    ...
    public GoogleAPI() {
        ...
        room1s.add(new Room1(0001, 180, 1, new Date(), "City Hotel", "Kiev"));
        room1s.add(new Room1(0002, 180, 1, new Date(), "City Hotel", "Kiev"));
        room1s.add(new Room1(0003, 180, 1, new Date(), "City Hotel", "Kiev"));
        room1s.add(new Room1(0004, 180, 2, new Date(), "City Hotel", "Kiev"));
        room1s.add(new Room1(0005, 180, 2, new Date(), "City Hotel", "Kiev"));
    }
    ...
    public List<Room1> findRooms(int price, int person, String hotel, String cityName) {
        ...
        System.out.println("found rooms in the GoogleAPI");
